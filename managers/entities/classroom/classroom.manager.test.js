...
describe('ClassroomManager', () => {
    ...
    test('create - success', async () => {
        ...
        req.body = { name: 'Math 101', capacity: 30, schoolId: '5f8d0d55b54764421b7156c1', __longToken: { role: 'superAdmin' } };
    ...
    test('create - unauthorized', async () => {
        req.body = { name: 'Math 101', capacity: 30, schoolId: '5f8d0d55b54764421b7156c1', __longToken: { role: 'student' } };
    ...
    test('update - success', async () => {
        mongoose.findOne.mockResolvedValue(null);
        req.body = { name: 'Math 101', capacity: 30, id: '5f8d0d55b54764421b7156c1', schoolId: '5f8d0d55b54764421b7156c1', __longToken: { role: 'superAdmin' } };
    ...
    test('update - unauthorized', async () => {
        req.body = { name: 'Math 101', capacity: 30, id: '5f8d0d55b54764421b7156c1', schoolId: '5f8d0d55b54764421b7156c1', __longToken: { role: 'student' } };
        classroomManager.managers.authorization.isAuthorized.mockReturnValue(false);
    ...
    test('getByID - success', async () => {
        ...
        const result = await classroomManager.getByID({ __query: req.query, __longToken: req.body.__longToken });
