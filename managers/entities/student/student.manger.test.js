...
describe('StudentManager', () => {
    ...
    test('create - success', async () => {
        req.body = { firstName: 'John', lastName: 'Doe', classroomId: '5f8d0d55b54764421b7156c1', username: 'johndoe', password: 'password', __longToken: { role: 'superAdmin' } };
    ...
    test('create - unauthorized', async () => {
        req.body = { firstName: 'John', lastName: 'Doe', classroomId: '5f8d0d55b54764421b7156c1', username: 'johndoe', password: 'password', __longToken: { role: 'student' } };
    ...
    test('update - success', async () => {
        req.body = { firstName: 'John', lastName: 'Doe', classroomId: '5f8d0d55b54764421b7156c1', id: '5f8d0d55b54764421b7156c1', __longToken: { role: 'superAdmin' } };
        mongoose.findById.mockResolvedValue({ _id: '5f8d0d55b54764421b7156c1' });
    ...
    test('update - unauthorized', async () => {
        req.body = { firstName: 'John', lastName: 'Doe', classroomId: '5f8d0d55b54764421b7156c1', id: '5f8d0d55b54764421b7156c1', username: 'johndoe', __longToken: { role: 'student' } };
        studentManager.managers.authorization.isAuthorized.mockReturnValue(false);
    ...
    test('update - student not found', async () => {
        req.body = { firstName: 'John', lastName: 'Doe', classroomId: '5f8d0d55b54764421b7156c1', id: '5f8d0d55b54764421b7156c1', username: 'johndoe', __longToken: { role: 'superAdmin' } };
        mongoose.findById.mockResolvedValue(null);
    ...
    test('delete - success', async () => {
        ...
        const result = await studentManager.delete({ __query: req.query, __longToken: req.body.__longToken });
    ...
    test('getByID - success', async () => {
        ...
        const result = await studentManager.getByID({ __query: req.query, __longToken: req.body.__longToken });
