...
describe('SchoolManager', () => {
    ...
    test('create - unauthorized', async () => {
        req.body = { name: 'Test School', address: { street: '123 Main St', city: 'Test City', state: 'TS', zipCode: '12345' }, __longToken: { role: 'student' } };
    ...
    test('update - success', async () => {
        mongoose.findOne.mockResolvedValue(null);
        req.body = { name: 'Updated School', address: { street: '456 Main St', city: 'Updated City', state: 'US', zipCode: '67890' }, id: '5f8d0d55b54764421b7156c1', __longToken: { role: 'superAdmin' } };
    ...
    test('update - unauthorized', async () => {
        req.body = { name: 'Updated School', address: { street: '456 Main St', city: 'Updated City', state: 'US', zipCode: '67890' }, id: '5f8d0d55b54764421b7156c1', __longToken: { role: 'student' } };
        schoolManager.managers.authorization.isAuthorized.mockReturnValue(false);
    ...
    test('delete - success', async () => {
        ...
        const result = await schoolManager.delete({ __query: req.query, __longToken: req.body.__longToken });
    ...
    test('getByID - success', async () => {
        ...
        const result = await schoolManager.getByID({ __query: req.query, __longToken: req.body.__longToken });
