...
describe('UserManager', () => {
    ...
    test('createUser - success', async () => {
        req.body = { username: 'testUser', password: 'testPassword', role: 'schoolAdmin', schoolId: '5f8d0d55b54764421b7156c1', __longToken: { role: 'superAdmin' } };
    ...
    test('createUser - unauthorized', async () => {
        req.body = { username: 'testUser', password: 'testPassword', role: 'schoolAdmin', schoolId: '5f8d0d55b54764421b7156c1', __longToken: { role: 'student' } };
